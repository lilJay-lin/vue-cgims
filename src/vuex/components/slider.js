 ...
 */
import {SET_ACTIVE_MENU, SET_SLIDER, SET_MENU_OPEN, SET_MENU_REL_PERMISSION} from '../mutations/mutation-types'
/*
  close: 是否关闭菜单，默认打开
  link: 菜单路径
...
const mutations = {
  ...
  [SET_MENU_REL_PERMISSION]: (state, menuRelPermission = {}) => {
    state.menuRelPermission = menuRelPermission
  }
}
